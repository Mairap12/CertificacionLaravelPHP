...
<html lang="en">
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #552C65" >
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{ route('home') }}">AGAPE</a>
            <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #6F467F" >
